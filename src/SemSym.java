...
class FnSym extends SemSym {
    ...
    private int totalParamOffset;
    
    public FnSym(Type type, int numparams,  int offset) {
        super(new FnType(), 0);
        returnType = type;
        numParams = numparams;
        this.totalParamOffset = offset;
    }
	...
	public void setTotalParamOffset(int size) {
		totalParamOffset = size;
	}
